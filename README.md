Hi there, I'm Reza Tabrizi
========================================================================================================================================

Back-End Developer | .NET & C# Specialist | Aspiring Full-Stack Developer
-------------------------------------------------------------------------
...
<p align="center"> 
 <a href="https://www.linkedin.com/in/tabrizi-me" alt="reza tabrizi's linkedin">
  ...
  <a href="https://meysamhadeli.com" alt="reza tabrizi's Gmail">
   <img src="https://img.shields.io/static/v1?style=for-the-badge&message=Gmail&color=967bb6&logo=Gmail&logoColor=FFFFFF&label=" />
 </a>
</p>

I'm a back-end developer skilled in ASP.NET Core and C#. I love building scalable RESTful APIs and creating clean, maintainable code with design patterns. I'm also good at optimizing both SQL and NoSQL databases. Problem-solving is my jam! 🌱 Currently expanding my skill set by learning Vue and Nuxt to become a full-stack developer. Always excited to learn new technologies and grow in fast-paced environments.
